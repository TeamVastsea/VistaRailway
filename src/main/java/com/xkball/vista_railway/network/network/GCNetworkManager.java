package com.xkball.vista_railway.network.network;
...
public enum GCNetworkManager {
    ...
    //当然也可以用别的，保证唯一即可。
    private final FMLEventChannel channel = NetworkRegistry.INSTANCE.newEventDrivenChannel(VistaRailway.MODID);
    ...
    private FMLProxyPacket createFMLProxyPacket(GCPacket pkt) {
        ...
        try {
            ...
            VistaRailway.logger.debug(e);
        }
        return new FMLProxyPacket(new PacketBuffer(buffer), VistaRailway.MODID);
    }
}
